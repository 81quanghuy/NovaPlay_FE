...
const variants: Record<Variant, string> = {
  primary:
    'bg-primary text-white shadow-[0_0_24px_rgba(255,44,85,0.4)] hover:bg-primary-hover active:bg-primary-press active:scale-[0.97] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-hover',
  secondary:
