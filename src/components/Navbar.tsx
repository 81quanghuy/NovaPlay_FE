...
function NovaPlayLogo({ size = 28 }: { size?: number }) {
  return (
...
export default function Navbar({ onNav, transparent }: NavbarProps) {
  ...
  const navBg = (transparent && !scrolled) ? 'transparent' : 'rgba(11,15,23,0.85)';
      ...
      <div style={{
        ...
        <div style={{ position: 'relative', width: 340 }}>
          <svg viewBox="0 0 24 24" width="16" height="16" style={{
            ...
            stroke: '#6b7385', fill: 'none', strokeWidth: 2, strokeLinecap: 'round' as const,
          }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 24, flex: 1, fontSize: 13.5 }}>
          {NAV_LINKS.map(L => (
            <div key={L.k} style={{ position: 'relative' }}>
              <button
                onClick={() => L.dropdown ? setOpenDD(openDD === L.k ? null : L.k) : onNav(L.k)}
                style={{
              ...
              >
                {L.l}
                {L.dropdown && (
                  <svg viewBox="0 0 24 24" width="14" height="14" style={{ stroke: 'currentColor', fill: 'none', strokeWidth: 2 }}>
                    <path d="m6 9 6 6 6-6" />
                  </svg>
                )}
              </button>
              {L.dropdown && openDD === L.k && (
                ...
                >
                  {L.dropdown.map(item => (
                    <a
                      key={item} href="#"
                      onClick={e => { e.preventDefault(); setOpenDD(null); }}
                      style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          ...
          >
            <svg viewBox="0 0 24 24" width="16" height="16" style={{ stroke: 'currentColor', fill: 'none', strokeWidth: 2, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const }}>
              <path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" />
              <path d="M10.3 21a1.94 1.94 0 0 0 3.4 0" />
            </svg>
            <span style={{ position: 'absolute', top: 8, right: 8, width: 7, height: 7, borderRadius: '50%', background: '#ff2c55' }} />
          </button>
          <button
            onClick={() => onNav('login')}
            style={{
          ...
          >
            <svg viewBox="0 0 24 24" width="14" height="14" style={{ stroke: 'currentColor', fill: 'none', strokeWidth: 2, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const }}>
