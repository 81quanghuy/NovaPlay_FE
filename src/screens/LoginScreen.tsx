...
import { NovaPlayLogo } from '../components/Navbar';
    ...
    <div>
      ...
      <div style={{ position: 'relative' }}>
        <svg viewBox="0 0 24 24" width="16" height="16" style={{
          ...
          strokeLinecap: 'round' as const, transition: 'stroke .2s',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#a8b0c0', fontSize: 14, margin: '0 0 32px' }}>
            {mode === 'login'
              ? 'Đăng nhập để tiếp tục xem phim yêu thích'
              : 'Đăng ký để bắt đầu hành trình điện ảnh của bạn'}
          </p>

          <div style={{ display: 'flex', gap: 10, marginBottom: 24 }}>
            {[
              { n: 'Google', bg: '#fff', tc: '#1a1d24' },
              { n: 'Facebook', bg: '#1877f2', tc: '#fff' },
              { n: 'Apple', bg: '#000', tc: '#fff' },
            ].map(p => (
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {mode === 'signup' && <Field label="Họ và tên" placeholder="Nguyễn Văn A" icon="user" />}
