...
function TopTen({ movies, onOpen }) {
  return (
    <section style={{ padding: '40px 64px 0', maxWidth: 1440, margin: '0 auto' }} data-comment-anchor="e7867bf910-section-74-5">
      <h2 style={{
        fontFamily: 'Manrope,sans-serif', fontWeight: 800, fontSize: 26,
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(5, 1fr)', gap: 24 }}>
        ...
        <div key={m.id} onClick={() => onOpen(m)} style={{
          display: 'flex', alignItems: 'flex-end', gap: 0, cursor: 'pointer', position: 'relative'
        }}>
            <div style={{
            fontFamily: 'Manrope,sans-serif', fontWeight: 800, fontSize: 140,
            ...
            marginRight: -22, position: 'relative', zIndex: 1
          }}>{i + 1}</div>
            <div style={{
            width: 140, aspectRatio: '2/3', borderRadius: 14, overflow: 'hidden',
