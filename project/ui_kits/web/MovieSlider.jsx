...
function HeroSlider({ movies, onOpen }) {
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{display:'flex', gap:10}}>
            <button onClick={()=>onOpen(movie)} style={{
