...
function MovieDetailScreen({ movie, onBack }) {
  ...
  return (
    <div style={{ background: '#07090f', minHeight: '100vh', color: '#fff' }}>
      <Navbar onNav={() => onBack()} route="detail" transparent />

      {/* Backdrop hero */}
      <div style={{
        position: 'relative', height: 560, marginTop: 0
      }}>
        <div style={{
          ...
          <div style={{ paddingBottom: 8 }}>
            <div style={{ display: 'flex', gap: 6, marginBottom: 14 }}>
              ...
              <span key={g} style={{
                ...
                background: 'rgba(255,44,85,.16)',
                border: '1px solid rgba(255,44,85,.4)',
            ...
            <div style={{ color: '#a8b0c0', fontSize: 14, margin: '0 0 22px' }}>
              The Boy and the Heron · {movie.year}
            </div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 14, fontSize: 14, marginBottom: 24, flexWrap: 'wrap' }}>
              ...
              <span style={{ color: 'rgba(255,255,255,.2)' }}>•</span>
              <span style={{
                padding: '3px 9px', background: movie.quality === '4K' ? '#ff8a00' : '#2ad4ff',
            ...
            <p style={{
              color: '#a8b0c0', fontSize: 15.5, lineHeight: 1.6, margin: '0 0 28px', maxWidth: 720
            }}>{movie.overview}</p>
            ...
            <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap' }}>
              ...
              <button style={{
                ...
                <svg viewBox="0 0 24 24" width="15" height="15" fill="none" stroke="currentColor" strokeWidth="2"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" /></svg>
                Yêu thích
              </button>
              <button style={{
                background: 'rgba(255,255,255,.08)', color: '#fff',
      ...
      {/* Body */}
      <div style={{ maxWidth: 1440, margin: '0 auto', padding: '24px 64px', display: 'grid', gridTemplateColumns: '1fr 320px', gap: 48 }} data-comment-anchor="6710e468f9-div-143-7">
        <div>
          {/* Tabs */}
          <div style={{
        ...
        <aside>
          <div style={{
            ...
            <h4 style={{ margin: '0 0 14px', fontSize: 14, fontWeight: 700,
              textTransform: 'uppercase', letterSpacing: '.06em', color: '#fff' }}>Thông tin</h4>
            {[
            ['Đạo diễn', 'Denis Villeneuve'],
            ['Sản xuất', 'Legendary Pictures'],
            ['Khởi chiếu', movie.year],
          ...
          <h4 style={{ margin: '0 0 14px', fontSize: 14, fontWeight: 700,
            textTransform: 'uppercase', letterSpacing: '.06em', color: '#fff' }}>Đề xuất</h4>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {window.NP_MOVIES.slice(7, 11).map((m) =>
            <div key={m.id} style={{ display: 'flex', gap: 12, cursor: 'pointer' }}>
                ...
                <div style={{ paddingTop: 4 }}>
                  <div style={{ fontSize: 13.5, fontWeight: 700, lineHeight: 1.3, marginBottom: 6,
